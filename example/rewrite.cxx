...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        outputFile.setWritingFile(argv[2]);//sets up on-disk writing
        outputFile.setCiftiXML(inputFile.getCiftiXML());//using default writing version, from CiftiVersion's default constructor
