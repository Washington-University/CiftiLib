...
FIND_PATH(glibconfig_INCLUDE_DIR NAMES glibconfig.h HINTS ${PC_GLIB_INCLUDEDIR} ${PC_GLIB_INCLUDE_DIRS})
...
SET(glib_INCLUDE_DIRS ${glib_INCLUDE_DIR} ${glibconfig_INCLUDE_DIR} ${PC_GLIB_PKGCONF_INCLUDE_DIRS})
